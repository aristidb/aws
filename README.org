...
| Name               | E-Mail                    | Company                                             | Components    |
|--------------------+---------------------------+-----------------------------------------------------+---------------|
| Aristid Breitkreuz | aristidb@gmail.com        | -                                                   | Maintainer    |
| Bas van Dijk       |                           |                                                     |               |
| David Vollbracht   |                           |                                                     |               |
| Felipe Lessa       | felipe.lessa@gmail.com    | currently secret                                    | Core, S3, SES |
| Nathan Howell      | nhowell@alphaheavy.com    | Alpha Heavy Industries (http://www.alphaheavy.com/) | S3            |
| Ozgun Ataman       | ozgun.ataman@soostone.com | Soostone Inc (http://soostone.com/)                 | Core, S3      |
| Steve Severance    | sseverance@alphaheavy.com | Alpha Heavy Industries                              | S3, SQS       |
